...
// Setup Call and making an offer
  ...
  return (
    <div>
      ...
      <div className="flex justify-center ">
        <button
          className=" bg-red-500 p-3 rounded text-white font-bold mr-2 "
          id="webcamButton"
          onClick={webcam}
        >
          Open Webcam
        ...
        <button
          className=" bg-green-500 p-3 rounded text-white font-bold mr-2 "
          id="callButton"
          onClick={makeCall}
        >
          Call
        ...
        />
        <button
          className=" bg-blue-500 p-3 rounded  text-white font-bold mr-2 "
          id="answerButton"
          onClick={answerCall}
        >
          Answer
        ...
        <button
          className=" bg-red-500 p-3 rounded  text-white font-bold place-items-center"
          id="hangupButton"
        >
          Hangup
        </button>
